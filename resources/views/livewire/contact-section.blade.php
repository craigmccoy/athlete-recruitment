                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-blue-100">{{ $athleteProfile?->email ?? 'N/A' }}</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <svg class="w-6 h-6 text-white mr-4 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <p class="text-blue-100">{{ $athleteProfile?->phone ?? 'N/A' }}</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <svg class="w-6 h-6 text-white mr-4 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <p class="text-blue-100">{{ $athleteProfile?->location ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    ...
                    <div class="space-y-3 text-blue-100">
                        <div class="flex justify-between">
                            ...
                            <span class="text-white font-semibold">{{ $athleteProfile?->graduation_year ?? 'N/A' }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span>High School:</span>
                            <span class="text-white font-semibold">{{ $athleteProfile?->school_name ?? 'N/A' }}</span>
                        </div>
                        @if($athleteProfile?->gpa)
                        <div class="flex justify-between">
                            <span>GPA:</span>
                            <span class="text-white font-semibold">{{ number_format($athleteProfile->gpa, 1) }}</span>
                        </div>
                        @endif
                        @if($athleteProfile?->sat_act_score)
                        <div class="flex justify-between">
                            <span>SAT/ACT:</span>
                            <span class="text-white font-semibold">{{ $athleteProfile->sat_act_score }}</span>
                        </div>
                        @endif
                    </div>
                </div>
