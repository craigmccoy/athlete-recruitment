...
<?php $component = App\View\Components\AppLayout::resolve(['title' => 'Profile Settings'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <?php if(Laravel\Fortify\Features::enabled(Laravel\Fortify\Features::updatePasswords()) && config('fortify.email_login_enabled', true)): ?>
...
<?php endif; ?>
            ...
            <?php if($hasOAuthProviders): ?>
                <div class="mt-10 sm:mt-0">
                    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('manage-oauth-connections');
...
$__html = app('livewire')->mount($__name, $__params, 'lw-380101111-5', $__slots ?? [], get_defined_vars());
