...
<?php $component->withAttributes([]); ?>
        ...
        <div class="mb-6 bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded">
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-4">
                        <a href="<?php echo e(route('admin.profile')); ?>" class="inline-flex items-center px-4 py-2 bg-yellow-600 text-white rounded-md hover:bg-yellow-700 transition">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="<?php echo e(route('admin.profile')); ?>" class="block p-6 bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg hover:shadow-lg transition">
        ...
        <!-- Season Stats Card -->
        <a href="<?php echo e(route('admin.stats')); ?>" class="block p-6 bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg hover:shadow-lg transition">
            <div class="flex items-center justify-between mb-4">
        ...
        <!-- Highlights Card -->
        <a href="<?php echo e(route('admin.highlights')); ?>" class="block p-6 bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-lg hover:shadow-lg transition">
            <div class="flex items-center justify-between mb-4">
        ...
        <!-- Awards Card -->
        <a href="<?php echo e(route('admin.awards')); ?>" class="block p-6 bg-gradient-to-br from-yellow-50 to-yellow-100 border border-yellow-200 rounded-lg hover:shadow-lg transition">
            <div class="flex items-center justify-between mb-4">
        ...
        <!-- Testimonials Card -->
        <a href="<?php echo e(route('admin.testimonials')); ?>" class="block p-6 bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-lg hover:shadow-lg transition">
            <div class="flex items-center justify-between mb-4">
        ...
        <a href="<?php echo e(route('admin.contacts')); ?>" class="block p-6 bg-gradient-to-br from-red-50 to-red-100 border border-red-200 rounded-lg hover:shadow-lg transition">
            <div class="flex items-center justify-between mb-4">
        ...
        <!-- Website Link Card -->
        <a href="<?php echo e(url('/')); ?>" target="_blank" class="block p-6 bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-lg hover:shadow-lg transition">
            <div class="flex items-center justify-between mb-4">
        ...
        <a href="<?php echo e(url('/stat-sheet.pdf')); ?>" target="_blank" class="block p-6 bg-gradient-to-br from-indigo-50 to-indigo-100 border border-indigo-200 rounded-lg hover:shadow-lg transition">
            <div class="flex items-center justify-between mb-4">
