    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="flex items-start space-x-6">
                ...
                <div class="flex-shrink-0" wire:key="image-preview-<?php echo e($existing_image); ?>">
                    <!--[if BLOCK]><![endif]--><?php if($profile_image): ?>
                        <img src="<?php echo e($profile_image->temporaryUrl()); ?>" alt="Preview" class="w-32 h-32 object-cover rounded-lg border-2 border-gray-300">
                    <?php elseif($existing_image): ?>
                        <img src="<?php echo e(asset('storage/' . $existing_image)); ?>?t=<?php echo e(now()->timestamp); ?>" alt="Current Profile" class="w-32 h-32 object-cover rounded-lg border-2 border-gray-300">
                    <?php else: ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($profile_image): ?>
                        <p class="text-sm text-green-600 mt-2">✓ New image selected (<?php echo e($profile_image->getClientOriginalName()); ?>)</p>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div>
                    ...
                    <select wire:model="sport" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = \App\Helpers\SportConfig::getSports(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['graduation_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['school_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['gpa'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div x-show="$wire.sport === 'football'" class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Speed & Agility: <?php echo e($skill_speed); ?>%</label>
                    <input type="range" wire:model.live="skill_speed" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Route Running: <?php echo e($skill_route); ?>%</label>
                    <input type="range" wire:model.live="skill_route" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Hands & Catching: <?php echo e($skill_catching); ?>%</label>
                    <input type="range" wire:model.live="skill_catching" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Football IQ: <?php echo e($skill_iq); ?>%</label>
                    <input type="range" wire:model.live="skill_iq" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Leadership: <?php echo e($skill_leadership); ?>%</label>
            ...
            <div x-show="$wire.sport === 'basketball'" class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Shooting: <?php echo e($skill_shooting); ?>%</label>
                    <input type="range" wire:model.live="skill_shooting" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Ball Handling: <?php echo e($skill_ball_handling); ?>%</label>
                    <input type="range" wire:model.live="skill_ball_handling" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Defense: <?php echo e($skill_defense); ?>%</label>
                    <input type="range" wire:model.live="skill_defense" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Rebounding: <?php echo e($skill_rebounding); ?>%</label>
                    <input type="range" wire:model.live="skill_rebounding" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Passing: <?php echo e($skill_passing); ?>%</label>
            ...
            <div x-show="$wire.sport === 'baseball'" class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Hitting: <?php echo e($skill_hitting); ?>%</label>
                    <input type="range" wire:model.live="skill_hitting" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Fielding: <?php echo e($skill_fielding); ?>%</label>
                    <input type="range" wire:model.live="skill_fielding" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Pitching: <?php echo e($skill_pitching); ?>%</label>
                    <input type="range" wire:model.live="skill_pitching" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Base Running: <?php echo e($skill_base_running); ?>%</label>
                    <input type="range" wire:model.live="skill_base_running" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Arm Strength: <?php echo e($skill_arm_strength); ?>%</label>
            ...
            <div x-show="$wire.sport === 'soccer'" class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Dribbling: <?php echo e($skill_dribbling); ?>%</label>
                    <input type="range" wire:model.live="skill_dribbling" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Passing: <?php echo e($skill_soccer_passing); ?>%</label>
                    <input type="range" wire:model.live="skill_soccer_passing" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Shooting: <?php echo e($skill_shooting_soccer); ?>%</label>
                    <input type="range" wire:model.live="skill_shooting_soccer" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Defending: <?php echo e($skill_defending); ?>%</label>
                    <input type="range" wire:model.live="skill_defending" min="0" max="100" class="w-full">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Stamina: <?php echo e($skill_stamina); ?>%</label>
...
<?php /**PATH /var/www/html/resources/views/livewire/admin/manage-profile.blade.php ENDPATH**/ ?>