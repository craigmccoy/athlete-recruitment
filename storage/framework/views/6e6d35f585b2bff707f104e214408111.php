<section id="testimonials" class="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!--[if BLOCK]><![endif]--><?php if($testimonials->isNotEmpty()): ?>
            <!-- Carousel Mode -->
            <div class="relative">
                <div id="testimonials-carousel" class="overflow-hidden">
                    <div class="flex transition-transform duration-500 ease-out" id="carousel-track">
                        ...
                        <div class="w-full flex-shrink-0 px-4 py-1">
                            <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 <?php echo e($testimonial->is_featured ? 'ring-2 ring-blue-500' : ''); ?> max-w-3xl mx-auto">
                                    ...
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($testimonial->relationship): ?>
                                                <p class="text-xs text-blue-600 mt-1"><?php echo e($testimonial->relationship); ?></p>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </div>
                                    </div>

                                    <!--[if BLOCK]><![endif]--><?php if($testimonial->date): ?>
                                        <p class="text-xs text-gray-400 mt-2"><?php echo e($testimonial->date->format('F Y')); ?></p>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex justify-center gap-2 mt-6">
                    <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < $testimonials->count(); $i++): ?>
                    <button class="carousel-indicator w-2 h-2 rounded-full bg-gray-300 hover:bg-gray-400 transition <?php echo e($i === 0 ? 'bg-blue-600' : ''); ?>" data-index="<?php echo e($i); ?>"></button>
                    <?php endfor; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
            </div>
        <?php else: ?>
...
<?php /**PATH /var/www/html/resources/views/livewire/testimonials-section.blade.php ENDPATH**/ ?>